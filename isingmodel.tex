...
This problem is slightly adapted from the Project Euler Problem
  213.  The solution and the Julia scripts are adapted from
  \link{https://www.juliabloggers.com/flea-circus-for-the-new-year-celebration/}{Flea
    circus for the New Year celebration}.  A detailed discussion of
  the simulation approach is at
  \link{https://stats.stackexchange.com/questions/2427/how-should-one-approch-project-euler-problem-213-flea-circus}{How
    should one approach Project Euler problem 213?}.  Another solution
  using multinomial distributions is at
  \link{https://www.r-bloggers.com/2016/12/flea-circus/}{R-bloggers:
    Flea Circus}
\end{solution}
\hr
